                    ...
                    dialogState.item.targetQ4) && (
                      <Grid size={{ xs: 12, md: 12 }}>
                        ...
                        <Stack direction="row" spacing={1} sx={{ mt: 0.5 }}>
                          <Chip label={`Q1: ${dialogState.item.targetQ1 ?? "-"}`} size="small" variant="outlined" />
                          <Chip label={`Q2: ${dialogState.item.targetQ2 ?? "-"}`} size="small" variant="outlined" />
                          <Chip label={`Q3: ${dialogState.item.targetQ3 ?? "-"}`} size="small" variant="outlined" />
                          <Chip label={`Q4: ${dialogState.item.targetQ4 ?? "-"}`} size="small" variant="outlined" />
                        </Stack>
                      </Grid>
                    )}

                  {dialogState.item.budget && (
                    <Grid size={{ xs: 12, md: 12 }}>
                      <Typography variant="caption" color="text.secondary" display="block">
                        Anggaran:
                      </Typography>
